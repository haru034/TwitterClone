    ...
    <div class="container">
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item my-icon"><img src="/TwitterClone01/Views/img_uploaded/user/sample-person.jpg" class="js-popover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right"
        ...
        <div class="main">
            ...
            <div class="profile-area">
                <div class="top">
                    <div class="user"><img src="/TwitterClone01/Views/img_uploaded/user/sample-person.jpg" ait=""></div>
                                ...
                                <div class="modal-content">
                                    <form action="profile.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label class="mb-1">プロフォール写真</label>
